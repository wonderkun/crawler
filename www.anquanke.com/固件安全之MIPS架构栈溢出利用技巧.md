...
[![](./img/202219/t0131854bbea925a560.jpg)](./img/202219/t0131854bbea925a560.jpg)
...
1. MIPSROP (https://github.com/devttys0/ida/tree/master/plugins/mipsrop)
1. IDA里面的插件，专门针对MIPS
[![](./img/202219/AAffA0nNPuCLAAAAAElFTkSuQmCC)](https://p4.ssl.qhimg.com/dm/1024_793_/t016863771cf89665d4.png)
...
[![](./img/202219/AAffA0nNPuCLAAAAAElFTkSuQmCC)](https://p2.ssl.qhimg.com/dm/1024_595_/t01458a3194a39b38b8.png)
...
[![](./img/202219/AAffA0nNPuCLAAAAAElFTkSuQmCC)](https://p2.ssl.qhimg.com/dm/1024_556_/t01a23f9eab38fc2026.png)
...
还有比较好的是类似这样的：
1. `addiu $s0, $sp, 0x94 ; lw $t9, -0x7718($gp) ; jalr $t9 ; move $a0, $s0`
1. 但是个人推荐使用前一种通过执行 shellcode 来反弹 shell 的方式，MIPS 指令集无法开启 NX，所以使用这种方式比较方便。使用第二种执行 system 命令，如 `sysetm("telentd -p 123 -l /bin/sh")`的方法，可能因为参数控制不好的原因出现各种各样的问题。
...
[![](./img/202219/AAffA0nNPuCLAAAAAElFTkSuQmCC)](https://p5.ssl.qhimg.com/dm/1024_872_/t0168481c965f796b14.png)
